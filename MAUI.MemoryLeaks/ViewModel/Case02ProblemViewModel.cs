...
public class Case02ProblemViewModel : ItemsViewModel
{
    public Case02ProblemViewModel()
    {
        ...
        RecommendationClearItems = "The UI will fully load after more than 30 seconds. For only 1.000 items! Try scrolling on the CollectionView below, wait for it, probably it is still loading and consuming the memory...";
